...
text \<open>Trivial contradictions\<close>
...
text \<open>Quantifiers: normalization\<close>
...
text \<open>THE and \<exists>!\<close>
...
text \<open>Hilbert choice\<close>
...
text \<open>Axiom of choice\<close>
...
text \<open>Least operator\<close>
...
text \<open>Equivalence relations\<close>
