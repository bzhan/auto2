...
theorem while_cong1 [backward1]: "bequiv b b' \<Longrightarrow> cequiv c c' \<Longrightarrow> ceval (WHILE b DO c OD) st st' \<Longrightarrow> ceval (WHILE b' DO c' OD) st st'"
